...
def test_Naive_CNN_nc():
    ...
    config = wandb.config
    wandb_logger = WandBLogger(project_name="tesi", run_name="naive_nc", 
                               config=config)
    ...
    cl_strategy = Naive(model, optimizer, criterion, train_mb_size=15, train_epochs=25, eval_mb_size=15,evaluator=eval_plugin, eval_every = 1)
...
def test_Naive_CNN():
    ...
    cl_strategy = Naive(model, optimizer, criterion, train_mb_size=32, train_epochs=15, eval_mb_size=32)
...
def test_Naive_CNN_v2():
    ...
    cl_strategy = Naive(model, optimizer, criterion, train_mb_size=15, train_epochs=10, eval_mb_size=15)
